      ...
      <footer className="bg-slate-900 text-slate-400 border-t border-slate-800 text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div>
              <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-4">Marketplace</h3>
            ...
            <div>
              <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-4">Garantie & Sécurité</h3>
            ...
            <div>
              <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-4">Contact commercial</h3>
              <p className="text-xs mb-3 text-slate-400">Pour tout partenariat ou réclamation, écrivez-nous.</p>
              <div className="flex items-center space-x-2 bg-slate-800/60 p-2.5 rounded-lg border border-slate-700/50">
